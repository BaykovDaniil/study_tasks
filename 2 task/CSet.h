...
struct CSet{
	...
	CSet(int l, int u, vector<bitset<64>> &n, char* file);
	CSet(int l, int u);
	CSet(const CSet &);
	CSet(CSet &&);
...
struct CData0:public CSet{
	...
	CData0(int l, int u, vector<bitset<64>> &n, char* file):CSet(l,u,n,file){}
...
struct CData1:public CSet{
	...
	CData1(int l, int u, vector<bitset<64>> &n, char* file):CSet(l,u,n,file){}
